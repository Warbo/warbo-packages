...
builtins.mapAttrs (name: discs: ps1-launcher { inherit name discs; }) {
  ...
  "Ape Escape"."ApeEscape.chd" =
    "f12206808f1fb7f89de4480c181757e709d633d9b4171c2c59bf1bde2be2f5e0de18d";

  "Bloody Roar"."BloodyRoar.chd" =
    "f1220c69bc0b063d76449a49338f7630efd0a92498f2ef34bb02d279b954c6e67b2fe";
  ...
  "Clock Tower"."ClockTower.chd" =
    "f1220e83a3d4c70ff735b3821fd136006ba5022f5f95c865e653107b2f043cfed31c9";

  "Clock Tower 2"."ClockTower2.chd" =
    "f12201152e908c3e03b1f567af48149c491e21e614cf118c4a7d94ce48998b8a8e8c0";

  "Colin McRae Rally"."ColinMcRaeRally.chd" =
    "f1220563eb5d3b1d95332ff871e137f78c0f99aa962fb2b3b649b3b31cae0733271ab";
  ...
  "Final Fantasy 7" = [
    {
      "FinalFantasyVIIDisc1.chd" =
        "f1220657123d2beb8bc688104f132dc3efd66f0cf19978f0730d1e65ea42f6a7acb99";
    }
    {
      "FinalFantasyVIIDisc2.chd" =
        "f12204f37006bd68ede95c57aaa647bb2f415da72e6ce5a88974902516fa9ea59c852";
    }
    {
      "FinalFantasyVIIDisc3.chd" =
        "f122000413fc780bbf41e6c0baeff05dbaa9576114443c21ea95e2f92853abd525b47";
    }
  ];
  ...
  "Final Fantasy 8" = [
    {
      "Disc1.chd" =
        "f1220197138f04b1c91edfdce73a40256755e1390bcce00f36451633bc088c65ebd84";
    }
    {
      "Disc2.chd" =
        "f1220922169c5fbfe1b7142cc0a040284b46430bbd5119e905ea83b5c9361ccf04a80";
    }
    {
      "Disc3.chd" =
        "f1220e44398443be91e7cc0232928da08c414cb77a3335dc71e233bd63129d0aba18e";
    }
    {
      "Disc4.chd" =
        "f122055ac704886603ff5be546e2814193f2bab07528aabee4ade940a265e36968396";
    }
  ];
  ...
  "Final Fantasy 9" = [
    {
      "Disc1.bin" =
        "f12203add7528c87fecd87133e7af64a067f90d7b9d8ed446493464fefc5125049e0f";
    }
    {
      "Disc2.bin" =
        "f1220df44eb1e9f9e129055ce772329f630da0aab132158f15ee96de30ebe478bdb2e";
    }
    {
      "Disc3.bin" =
        "f122081841ee6a892b2eb4eae283a97137a069d540b86e5ebaf2e9342a3bb706e05c3";
    }
    {
      "Disc4.bin" =
        "f1220c6aad6b96ecd86d59ea7e933af6ae7b0b3defd93dc5978292f16a8771cf5b45d";
    }
  ];
  ...
  Galerians = [
    {
      "Disc1.chd" =
        "f12204b41f9abeadda1b328404b5d618a67367f3b357d053a6c333b013c5082e6708f";
    }
    {
      "Disc2.chd" =
        "f1220dbf4c76ef20beca472ea2f1b5104c7ad6b3a02f3854ac616b59821eb0cfd3bbd";
    }
    {
      "Disc3.chd" =
        "f12206a19c30c965bd829220c116d296eb1f0b7856d6c52f52a296b5a6dbe86a52dce";
    }
  ];

  "Gex"."Gex.chd" =
    "f1220f15c64419dcd913407b66942b1c3539e7d610131327a3cfef5c21fd4cb0f9db4";

  "Gex 3"."Gex3.chd" =
    "f12200afe35945cdbd9fb3a3b32edabca5983353f903c890f6a7ca76eb35e3dd77d7a";
  ...
  "In Cold Blood" = [
    {
      "Disc1.chd" =
        "f1220a25a9ebcc85dac39c0430cb5a007d692566f382ce9806580d35c488eba8b066a";
    }
    {
      "Disc2.chd" =
        "f1220320aec8d8dd2e0a0c2713af0b3623497a9b7d8dadd7de532ae174e92a4b6cb0e";
    }
  ];

  "Intelligent Qube"."IQ.chd" =
    "f1220085e88651a99b285411786fc01425b5fddb7cb56d3fd2864390135820d1cbc75";

  Iru."Iru_v1.0.chd" =
    "f12200e56aead9bbe896b0fef5ab8358e6b9653d4f7e9fb25d8cfceafe72865d32eef";

  "KISS Pinball"."KISSPinball.chd" =
    "f1220aa959ea8ec023537cf8f1139c8a60ba7c451dcbc4a1bf4eaf9c11efeef73b3ec";

  Koudelka = [
    {
      "Disc1.chd" =
        "f12205dc076bb71aa7d5a14deba36e84b710f75bf4cf9791f22dd57877a8a8ba21f00";
    }
    {
      "Disc2.chd" =
        "f1220fdf8b526a59c3e9d2cf3317dc664e485c4464a09f535649dd993a1db29035d92";
    }
    {
      "Disc3.chd" =
        "f1220b0348f535dc53c5ba05cde9764e07d8fed80f1c3f4c7f7c674688cf920f150bd";
    }
    {
      "Disc4.chd" =
        "f1220646088f16d6d724a0976d2caf9d8c733d0b724dd5761e0427b1c3ffa8b7643a2";
    }
  ];

  "Legacy Of Kain Blood Omen"."BloodOmenLegacyOfKain.chd" =
    "f12209e40f898458c8a40e3fa05e381280c4667e42ff2d07ac969c89593764f8030fb";
  ...
  "Metal Gear Solid" = [
    {
      "Disc1.chd" =
        "f1220e637941fca92b05d47352a30fbc6b79e28952dbbf722ef11f6aa5d0d7a272c2f";
    }
    {
      "Disc2.chd" =
        "f1220695e1a0ac2656399320952386bfd6a0d96f0c40b0e4faed87f4405866f46779d";
    }
  ];
  ...
  "Micro Maniacs"."MicroManiacs.bin" =
    "f1220ddfdbf86e1c7b001ff6a9188ce11725a9555678861d488e420ecaa27d0a62166";
  ...
  "Nightmare Creatures 2"."NightmareCreaturesII.chd" =
    "f1220428243f705c7adb6c8f68deedb5d2c57fccc06f49c330173233091913e8c2985";

  "Oddworld Abes Exoddus" = [
    {
      "Disc1.chd" =
        "f12207e73468d687247ca0ab61b54bf3c4ad6fc8974f19aefda46c2eb4e4bc4a38112";
    }
    {
      "Disc2.chd" =
        "f12201b322bcdb78473d5ee59dbb31dfc5d264fc7ff54fd99160993153bf21ed34bc4";
    }
  ];

  "Oddworld Abes Oddysee"."AbesOddysee.bin" =
    "f122018bf320880981011a755026352adc781d0810e4e3ce76cc04f51ca989d380340";
  ...
  "Parasite Eve" = [
    {
      "Disc1.chd" =
        "f12206d76aed5c106901532d3382a8030a1cf9567832b27b7b1701bfdcdb189703969";
    }
    {
      "Disc2.chd" =
        "f12206e460fb30c0606162002d89fb09acb6ffdae35e4d81331ed076a843fa4db73ff";
    }
  ];
  ...
  "Parasite Eve 2" = [
    {
      "Disc1.chd" =
        "f1220498b46ab00c0bb3ef5ffbe15b11ea935e2ceabe629197645c5d2e02d2e63b76d";
    }
    {
      "Disc2.chd" =
        "f1220ce24fe49bee217bbebcd6f43b6186e4deef80060fcbb58d7eeae6c146200ccdc";
    }
  ];
  ...
  "Resident Evil 2 Claire" = [
    {
      "Claire.chd" =
        "f1220e90efb2034070b7c4255e2ab4c6f821a2c69be4da0e8ed5081b3db11b720e074";
    }
    {
      "Leon.chd" =
        "f1220aeb8cc46bcd18acf9708c169be1be20994ff3917ba9ac98aff0dc68c177af56e";
    }
  ];
  ...
  "South Park"."SouthPark.chd" =
    "f1220d92c5268a1c3e361e40e699231bb5402398f411819bad49db1835e8b0d535524";
  ...
  "Tekken 3"."Tekken3.bin" =
    "f1220f20a200eaaf276986fe11f1ba2f1316eb2c0c46ae5da9870d47e9bb01baa1f90";
