...
builtins.mapAttrs (name: args: amiga-launcher ({ inherit name; } // args)) {
  "Alfred Chicken".floppies = [
    "sha256-CN4vQeKucCl+7Mg6nf1u8EYvHouqx88/LHBLEmsJVVI="
  ];
  "Alien Breed".floppies = [
    # Disk1 story, disk2 bootable?
    "sha256-SfbCwtUGdU6jqsdt2Rs2MS6xtJB4kY6vGdUTONwuBZ0="
    "sha256-9gZw/v2zpnVOOuikci9T+K1lOHSR2uy9ReUP2NyInEg="
    "sha256-ChEfePw+ALowq1WYPzlk3Qdt3M7J0e28xYVQ3Tb9/6E="
  ];
  "Alien Breed 3D".floppies = [
    "sha256-U9qwfP/yOwX44DVQDCAkU1uT/4HuRYcuQPqbg+CnJGU="
    "sha256-WwtVEZNMyeQv+4zcA8lT5m3yDuZACqdoycF4VdqPiAo="
  ];
  "All Terain Racing".floppies = [
    "sha256-QCHzZNvpXgvigCebw7+63Dj/KUNpRnU//9aSllt88W8="
    "sha256-XARVqyJ0GtQ4i14KycQCSGVSCThRsNTYccLLFOpcmUs="
  ];
  "Allo Allo".floppies = [
    "sha256-XlG5yqcShTdT+JpThY7ULNFWzRrhDhYBeebjqtVjxCM="
    "sha256-zHjQ4mR8xdJJZv+xl+Oiafc+dBXvQ1W0qF5nHqv6d4I="
  ];
  "Amazing Spider Man".floppies = [
    "sha256-PEZhgIPiVnmvE5AX00b+knrgoezwq/wOKeTK/hLD6qw="
  ];
  AmigaWin.floppies = [ "sha256-tkyuAxMpNy31q9yrGtZ8drf12yu335aCug3b38O+4h8=" ];
  "Arabian Nights".floppies = [
    "sha256-30RzqW1gJASzrGfRS3GZ+7MdjhJleCRaiS3i/4JDHbM="
    "sha256-RHlKxC9zI9NwTClGq4l1MSzHNhJOHSe1b1sp4xyGLtA="
  ];
  "Arcade Pool".floppies = [
    "sha256-87OetHEhpuDJBne77STHIhcp15kuVQTaoo9oTg6JWUs="
  ];
  Assassin.floppies = [
    "sha256-M0ahMOcivMng3zbt+N+rfA+8vI+0xy6nJT/8EMS8V0Q="
    "sha256-FQvYDsDMen9MwYurg60+V+ifuCj6fyyQ2IWAQTlt7FM="
  ];
  "Assassin Special Edition".floppies = [
    "sha256-1m36AXvSh2RRdlKj7Q9zj1xvtUJNwroS/N9zb4YP0qI="
    "sha256-oG4e6AGp0cR1BnI1Xrpm1+ErHi0qRhpqAMMF0wciBuI="
  ];
  Atoms.floppies = [ "sha256-D/pmL5kMaHpvTxQIm+Enj9rDO7B6lXQW0PIYHhsGOu8=" ];
  Baldy.floppies = [ "sha256-wllNh9YfpQxS1ospHdsDtsot/NGzyb8Im6rMZ48xuuY=" ];
  Ballistix.floppies = [
    "sha256-G21qK5Dj3zSG8LDAXj5ofYQKr0xXLWBJLjrBfqwSaPI="
  ];
  "Bally 2".floppies = [ "sha256-FIc5nAScJxawFxlc9zlBkT6uj36Wa3yOGOqaHqDT3js=" ];
  "Bally 5".floppies = [ "sha256-zV+e2txs2mjrXd1KTbo5NOXTcq7azHx2NX23aAfEkpA=" ];
  Banshee.floppies = [
    "sha256-d8zGwYCbs3z+mfMB0kV3usQDhskKRJYvq5Ns6AcCuvI="
    "sha256-xxlXyMTS2E7v9Og3kkl8H89VuhuRa/fMQDqAc/c64BY="
    "sha256-/dG6RZYMUVf0bemg7/pBJtSewu1UBB5cc/fVXgEGRM4="
    "sha256-ibpwBchmYa3OKEj8DbGf8C88/WHOZ5MxDM2YGO8U3ok="
  ];
  "Base Jumpers".floppies = [
    "sha256-wHqzSQFkedvwgcTOitrnw9Gp4AYIxcvQnhaSlcI7PXA="
  ];
  "Beast Busters".floppies = [
    "sha256-z3ZM6KU4OrVWMKM+l8uoOhK+lIOEO/z896awVrihtIc="
    "sha256-EwDUbV9s7gqZkvjDY7FClLSgHNNI0MG+8GPOnp5fR8o="
  ];
  Beavers.floppies = [
    "sha256-kgVHjGPwY/2Y8jPyXPLvNkHhwvgmvYlC5M42rObO45U="
    "sha256-GVCGq29hz/oQw9K567mLzrzUE/U6gZKVwKxlx+mNe/I="
  ];
  Biplanes.floppies = [ "sha256-iKMeH+EkI+ZKbqR9Iqh718tCom5rxNf2UzTMxdZuhLE=" ];
  Blastar.floppies = [
    "sha256-jGLEyzdxE9ySH1O6UPRW3MRkogi3uYR5JDZgHKeUnnM="
    "sha256-p8StIX2x6IMUcgNs9AOKsqIGniZXYWHjjBLLey85CwU="
    "sha256-29gEbiNCHqHtmGCyesF+PfJUX1c/Qf9txptiT7rhccE="
  ];
  Blob.floppies = [
    "sha256-/BvsILDyUn0thqTcOcDTezxOIgWSEVg4RnkrmfPAyfQ="
  ];
  ...
  Bograts.floppies = [
    "sha256-DIMjZBQzTLk7bOspOm28NB9/AGKCO4aqbCPjSzrPpYQ="
    "sha256-RZIhvY7GnUdu2kCFU926s7ODXnnIF62JhFo5ePQJD7c="
  ];
  "Bomb X".floppies = [
    "sha256-lLVbdgWt+eNOxTpm6nX6yxQWxD/q2sEnfL+12af+KfA="
  ];
  Brat.floppies = [
    "sha256-WfgjlmD3WyiraY+7b1Uc3UFN4jvVPq3MkrJhRvqgbsI="
    "sha256-YTGAOwWYn10vFjiu8/axgHPUPz3aUL1M2KZulFp9yo0="
  ];
  Breathless.floppies = [
    "sha256-EfseR1LYXRRnMK105+d8aVXQvSGUDPZRZe8p01V0nJU="
    "sha256-XDdNvO67zUVWuSCjmeo+0aKZbVPcApJKG4fwd8O9GQU="
    "sha256-DPhZmwHNzAeigyOCTbncNkC2djdJDo9wGM3RyGsGOls="
  ];
  "Brian The Lion".floppies = [
    "sha256-WdKR+GslcSacn9zw3bcsuI6/x/fJBo4fdRujAGBmTDc="
    "sha256-yXBftEtW+Qpa3Fdn2SdiqrECLrCPX7qGoTGMIAV3xdc="
    "sha256-gSFQBltiNKcXlE9rGMSaqbF/FTb2NrUr6dIjLFQ+bTg="
  ];
  "Brik Fighter".floppies = [
    "sha256-GgSdycZBCCiXFqL/l1s1KjuWmclHk/W9PqO0iZrj19g="
  ];
  "Bubba N Stix".floppies = [
    "sha256-z/JeeCje1xx5Tgu19C+D/YxBHLSHxx+mwVCqFU6dQW4="
    "sha256-jnY7ChBhMU8KZqLdCtK5eEHvPqkteBkmKfMNYiTfFgM="
  ];
  "Bubble Bobble".floppies = [
    "sha256-eClx/gWYvj6uTmC5yMQGIP43SBofhkepyCVb2OEwzdM="
  ];
  "Bubble Dizzy".floppies = [
    "sha256-tsrsE1OlSItui0SPVp9T7UfhNte5j30HdZODuW6SRhM="
  ];
  "Bubble And Squeak".floppies = [
    "sha256-Uqmg8e6SSasx2BTan6/4YDVznv1B+7Xaso/jszl0AIc="
    "sha256-aFSCIvphhAu3Zd0KcsTetC3uYV3nDPz+XIHi2+S/bJg="
  ];
  "Burning Rubber".floppies = [
    "sha256-aLkF3CDTUbeAQiepoqXHPrlzMoekiXpAC8pGO4L7lhM="
    "sha256-CmdD+WKLpPlDgYXjfwhe/+8MQurxWCsCVt8HAhXTAZE="
  ...
  "Crazy Pipes".floppies = [
    "sha256-64JGNanZ5H5c87Ol4lR0cZZqeQ8r7WeH+2Z54ZeDjYg="
  ];
  "Crazy Sue Goes On".floppies = [
    "sha256-CP+tVbz4yYpNgD9MYt/kXgNJV5OXuuGNuzYWUHN2T18="
  ];
  "Crazy Sue".floppies = [
  ...
  "Deluxe Galaga".floppies = [
    "sha256-fQ4BlqCK45Cj/NkI2Kj4d8g3/j8zHIw2Efau+d6fX1k="
  ];
  ...
  "Dizzy Collection 1".floppies = [
    "sha256-cf92I3vsrwhKMa74QnIEen052vXuzQTVh45gopdD69E="
  ];
  "Dizzy Collection 2".floppies = [
    "sha256-JWgXYRA+GWa+CMa7cBNOKJlxKPBA+tcz/VfCDNst7MU="
  ];
  "Dizzy Prince Of The Yolkfolk".floppies = [
    "sha256-i+UvNMFw6fp7ViErAiYnyK5WqypO89cHpA09bU9YMoc="
  ];
  "Dizzys Excellent Adventures".floppies = [
  ...
  Frontier.floppies = [
    ...
    "sha256-pYs3s9sqESJnDGdnl24BXYmexYlip0B+XqlEcx/72r0="
  ];
  Fuzzball.floppies = [
    # Disk 1 boots into intro animation, then asks for disk 2. It only seems to
    # check DF0, which would require manual swapping to disk 2. Instead we start
    # with disk 2 in DF0, to boot straight into the game. We include disk 1 in
    # DF1 for completeness (it's unused).
    "sha256-Uj7fyyiLwfXndHPe0oVSiOpc85xfUgJGT8OhDbhggHI=" # Disk 2
    "sha256-Bh+iEWV2MEZU9avBU2xe+h6PxxKXmYE+SRA/DqHydhY=" # Disk 1
  ];
  "Giddy 3".floppies = [ "sha256-6GgvR0d1gLfIxT0z/uS7+SPcQMrMkZBg0C3DVUMM7vs=" ];
  Gorf.floppies = [ "sha256-d4NjdpEcEtBULx2NsitcplaHHEcwa8QScU2eOTFFiAg=" ];
  HeroQuest.floppies = [ "sha256-6iFLQjxczEK4wvJE45d6/VR1F1LKs6OrKS9Th+CvLeA=" ];
  "Horror Zombies From The Crypt".floppies = [
    "sha256-kSWGsw4dIXT53oPN8WXoa7p/NwTfcyFc8Hsrh4BhS2c="
  ];
  "Jouster 3".floppies = [
    "sha256-M1b0DF9nFdB6nm4rmky8kuCQe7QC9m+HEtvshkFfjN4="
  ];
  KAK.floppies = [ "sha256-vx33prdSpgXFeujUynPbmTmGwlvomsL+kvCFWVNmQ9I=" ];
  "Kid Gloves".floppies = [
    "sha256-62l/Ft/Eq8Q6viAPcNsJI6xRRYNQ3osJCeQToYWETlc="
  ];
  "Kid Gloves 2".floppies = [
    "sha256-tGSs9y1wnUav0VrKIbCLd2qbULEX87pvgFk+yLRecsQ="
  ];
  Knightmare.floppies = [
    "sha256-K9e+Udp8eV5VmafOZjOiBQcmguyXjyRKVc0kzzhwAJY="
    "sha256-55RdIoBDBsKXAzqmtnKzh7AY9DPpmhS1CBEgX0KQ+G8="
  ];
  "Magicland Dizzy".floppies = [
    "sha256-OQ2rTtNmSo/lmVBM4bBS0Z/zOBF93vgqwMukTiXxRFI="
  ];
  Maniacball.floppies = [ "sha256-yOETeyAQ9SYAH4DuVWSJ8t1Gfe5pg/wtN2/bZjlOzQw=" ];
  ...
  "Oh No More Lemmings".floppies = [
    "sha256-C8YDiA9WTGSRoTMosCOoFwdLee7zOM46Mb7b8WJb0JA="
  ];
  Oscar.floppies = [
    "sha256-qzryl4kkjxM71FkSQghuA4bcD6Ucl+SKCyVg9D262ss="
    "sha256-FS1Cg0fX2eciL67pyeG0ZBoyHnk8hhEyp4XYZC4BQ0Q="
    "sha256-JKzxlRZNpzl9iFatybDsYlNwKiTgaEo7dEH8CSL4eGQ="
  ];
  Pengo.floppies = [ "sha256-6pCsssT/VS/YV3PAgsny8nj8HFxp939Oe1TqmKQJFFQ=" ];
  "Pinball Dreams".floppies = [
    "sha256-ewaHABycdMAjsz/XumkgyZzP2J5hUIkOwpSAY7gsR6w="
    "sha256-pbQq7jlChfrBDlasF3ylqzRKy0pE47T4lC4ad7YAwDU="
  ];
  "Pinball Fantasies".floppies = [
    # TODO: Different disks provide different tables. Currently allows first 2.
  ...
  "Pinball Illusions".floppies = [
    ...
    "sha256-gi3qgOtFt+anKhftkPExXhyQyqxSiKlYtVcUCC5UhWc="
    "sha256-she40nl1ZBgP+7Wryd4xd4bSDSJ+NArUeheIRZV2p0k="
    "sha256-fdyJrAzg1A7F/006cRNOZBHLBqV9qcTS4k43+uCZ284="
  ];
  "Pinball Mania".floppies = [
    "sha256-xw2SC+Bm/KUF/dJukvgKoWV7h40GdLkfHoIGaXGo4Lo="
    "sha256-7gAvSsApWmSqHynmjcUMN/4xUTsum9GUE7sINa9l/cw="
    "sha256-tMhPqS+GDiETG4BUxUSiCu/NAUbl8mueQY905L9ENLA="
  ];
  "Pinball Prelude".floppies = [
    "sha256-4CsohaN9MhWoF4N9bJxhpgxLCQkuWGRy/aZ1Pcee+fM="
    "sha256-iy41DXT/iT1IkizWGdz+NYWhqFclJkogxTSec139m+A="
    "sha256-dmNH/9K3HUGZYK8h9KwW92uWxT7xd2yZVzfvxL/ZFgk="
    "sha256-9UrDvmBQHIiGWgNk/BgtdtuoSQyhwNC09SO8+dqD0i0="
  ];
  "Pipe Dream".floppies = [
    "sha256-0D6QhCXV/413yfPEbQuJoLsNeRWYKwlpDTU8XXJ6a2k="
  ];
  Pipeline.floppies = [ "sha256-oyXczmpCMSoD0fyWnkqckQOj89l851Ymgexv57eNpJw=" ];
  Poing.floppies = [ "sha256-ccRyjCGBaxKzuTqUYktFEgnejEpFCeqlBqgxR94X1sI=" ];
  "Poing 3".floppies = [ "sha256-vqZ1Vj2Q9b1uiTHeiR5hGvnXs1w6m94cvIKHsgG6Xcg=" ];
  "Poing 5".floppies = [ "sha256-kvhgRMZGKz50+3Ox2C1v0y4i690ds+eE9/rPSHtrHKQ=" ];
  "Poing 6".floppies = [ "sha256-81lcPiWYLwwEazaJIeuuJSCXDmoOM/M6fccp/WbO1N4=" ];
  Q-Ball.floppies = [ "sha256-zmG32Wr/R5dWtiLkybAmfyJNBbB3iZ7vsaW4lUhcNt4=" ];
  Quartz.floppies = [ "sha256-+LQv3MIOm5pifZR+sD7tQyFnXr/AOa8nE3autE3VWtM=" ];
  "Real Pinball".floppies = [
  ...
  "Scorched Tanks".floppies = [
    "sha256-ZDAtucwJv2QAfxEAvP8QE6nsHw/zrdG9AQEzZW1t7d0="
  ];
  ...
  "Shufflepuck Cafe".floppies = [
    "sha256-Tb6Eb+rMgUsZvjxPj0bR1IoWBcjoGVMXwMDvPOTywyU="
  ];
  "Soccer Kid".floppies = [
    "sha256-H0dyZz7MFeN7diqbnf/vZfNAhyPpCnZn6UFlqhrvMnk="
    "sha256-WMb4pSMKmX4AER8MC2Gt4TlWuJpr0E2C4NLItnCTTWg="
    "sha256-8VHMws9gbdxhd3jjLoj+iNFK8GagH+jFH1xDmTNmkXA="
    "sha256-mGKZF4VRh4SX9Ttnm1gkmdf4P3ntLHPsqKvJhX1hscY="
    "sha256-iLfcv+UCeDUpWRKpg3/W2R7KTlUv29ghyS6JKEnM01A="
  ];
  "Spatial Hyperdrive".floppies = [
    "sha256-hInD99+6Qv6xpfi9t2rsFffpywV1ItT2c4ClijhThBI="
  ];
  "Spellbound Dizzy And Dizzy Panic".floppies = [
    "sha256-zu8QejCJi5BAJAYChglcwidGTylyIO5CG46RaIb1jUY="
  ];
  Squamble.floppies = [ "sha256-zqUJLWKdDEbz7cUoTuZNKX7Sg1P1WVA4Fik4el/v8F4=" ];
  Stardust.floppies = [
    "sha256-JJIiDGV2DKPI+UMvw+uDygvrv1zJ0u8HJW26xSgPSew="
    "sha256-kr5t/x8VoUJw43Gt1G3q5itfBaZQWKjuhv523qzKSC8="
    "sha256-jhUwo0UOpRHqiCWyobkRMBYQVlFZmRfpU4GBpVuVvmY="
  ];
  Statix.floppies = [
    "sha256-qyA9KSwlyJO06BP2pDRyhbG8lFdEgNtkN08gkMqFWRc="
  ];
  "Summer Camp".floppies = [
    "sha256-RAfODDIAMXLzmZSrxS8ZbSiFsFbLBJ2ElD+x7cuitH4="
  ];
  "Super Foul Egg".floppies = [
    "sha256-42hoTP69Pb/xt9GmzMUzN457pnOf5NmbWxzrMK4hDKE="
  ];
  "Super Nova Fruit Machine".floppies = [
    "sha256-DP21BBfT2NE2XqQFFd2jV362Xw/wtjE30u+kiaIPqWI="
  ];
  ...
  "The Simpsons Bart Vs The Space Mutants".floppies = [
    ...
    "sha256-fTvdIwiH+p7+Q1ocKjT9gxJl71DrU64S/jL0PrGRfVg="
  ];
  ...
  "Zool 2".floppies = [
    "sha256-dxcNoXLp96WZI1gl7c2em/Hd1kDu8Rhd4pNjYfxk2PI="
    "sha256-6I3iGAI2qK4cenlFUY2Wk2NvE3P6k7ySohaWx0vjqgA="
  ];
