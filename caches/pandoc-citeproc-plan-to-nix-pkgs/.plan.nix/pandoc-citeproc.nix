  ...
  components = {
    "library" = {
      ...
      modules =
        ...
        ++ (pkgs.lib).optional (flags.embed_data_files) "Text/CSL/Data/Embedded";
      hsSourceDirs =
        [
          "src"
          "compat"
    ...
    exes = {
      ...
      "test-citeproc" = {
        ...
        build-tools = [
          (hsPkgs.buildPackages.pandoc-citeproc
            or (pkgs.buildPackages.pandoc-citeproc or (buildToolDepError "pandoc-citeproc"))
          )
        ];
