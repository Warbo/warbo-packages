{
  pkgs = hackage: {
    packages = {
      ...
      "file-embed".revision = (((hackage."file-embed")."0.0.11.1").revisions).default;
      ...
      "doctemplates".revision = (((hackage."doctemplates")."0.8").revisions).default;
      ...
      "tasty-lua".revision = (((hackage."tasty-lua")."0.2.0.1").revisions).default;
      ...
      "skylighting".revision = (((hackage."skylighting")."0.8.3").revisions).default;
      ...
      "doclayout".revision = (((hackage."doclayout")."0.2.0.1").revisions).default;
