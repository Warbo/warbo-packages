{
  pkgs = hackage:
    {
      packages = {
        "jira-wiki-markup".revision = (((hackage."jira-wiki-markup")."1.0.0").revisions).default;
        ...
        "regex-pcre-builtin".revision = (((hackage."regex-pcre-builtin")."0.95.1.1.8.43").revisions).default;
        ...
        "base-compat-batteries".revision = (((hackage."base-compat-batteries")."0.11.0").revisions).default;
        ...
        "hs-bibutils".revision = (((hackage."hs-bibutils")."6.8.0.0").revisions).default;
        ...
        "skylighting-core".revision = (((hackage."skylighting-core")."0.8.3").revisions).default;
